...
### 3. 难度标注（每题必标）
在题目后附加：
\`难度：easy/medium/hard | 考点：细节定位/推理判断/词汇理解/态度推断/主旨归纳 | 预估：X秒\`
...
**【真题示例1-细节题】**
题干：What trait do all great professionals share?
...
干扰项分析：
- A. Continuous work（原文强调的是反思而非持续工作，原词"work"干扰）
- B. High intelligence（偷换概念，professionals≠intelligent）
- C. Long working hours（过度推断，work hours多≠professionals）
- D. Regular reflection ✓（同义替换：underlies=share trait；prerequisite≈share）
...
**【真题示例2-推理题】**
题干：What can we infer from the passage about the Goldilocks principle?
原文：...the principle that things need to be "just right" for optimal results...
答案：A
A. Things must be balanced for best outcomes

干扰项分析：
- A. Things must be balanced for best outcomes ✓（抽象概括，符合推理逻辑）
- B. Only extreme measures work（与原文矛盾，是反义干扰）
...
原文：...While remote work offers flexibility, it also raises concerns about team cohesion and mental health. Nevertheless, many companies...
答案：C
...
【题目】题干内容
A. 选项A B. 选项B C. 选项C D. 选项D
难度：easy/medium/hard | 考点：xxx | 预估：X秒
请回答A/B/C/D
